...
public class ViewCompat {
    ...
    static class BaseViewCompatImpl implements ViewCompatImpl {
        ...
        public void setChildrenDrawingOrderEnabled(ViewGroup viewGroup, boolean z) {
            ...
            try {
                ...
                objArr[ViewCompat.SCROLL_AXIS_NONE] = Boolean.valueOf(z);
    ...
    static class LollipopViewCompatImpl extends KitKatViewCompatImpl {
        ...
        class C00381 implements OnApplyWindowInsetsListenerBridge {
            final /* synthetic */ OnApplyWindowInsetsListener val$listener;

            C00381(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        ...
        public void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
            if (onApplyWindowInsetsListener == null) {
                ...
                ViewCompatLollipop.setOnApplyWindowInsetsListener(view, new C00381(onApplyWindowInsetsListener));
            }
        }
