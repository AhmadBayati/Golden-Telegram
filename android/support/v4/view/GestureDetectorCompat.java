...
public final class GestureDetectorCompat {
    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            boolean z = (action & NalUnitUtil.EXTENDED_SAR) == 6;
            ...
            switch (action & NalUnitUtil.EXTENDED_SAR) {
                ...
                case SHOW_PRESS /*1*/:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        int pointerId = motionEvent.getPointerId(LONGPRESS_TIMEOUT);
                ...
                case Method.TRACE /*6*/:
                    ...
                    this.mLastFocusY = f;
                    this.mDownFocusY = f;
                    this.mVelocityTracker.computeCurrentVelocity(PointerIconCompat.TYPE_DEFAULT, (float) this.mMaximumFlingVelocity);
