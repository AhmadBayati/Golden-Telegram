...
public final class LinkifyCompat {
    ...
    static class C00261 implements Comparator<LinkSpec> {
        C00261() {
        }
    ...
    public static final boolean addLinks(@NonNull Spannable spannable, @NonNull Pattern pattern, @Nullable String str, @Nullable String[] strArr, @Nullable MatchFilter matchFilter, @Nullable TransformFilter transformFilter) {
        ...
        for (int i = 0; i < strArr.length; i++) {
            ...
            strArr2[i + 1] = str2 == null ? TtmlNode.ANONYMOUS_REGION_ID : str2.toLowerCase(Locale.ROOT);
        }
            ...
            try {
                ...
                if (findAddress != null) {
                    ...
                    if (indexOf >= 0) {
                        ...
                        i += length;
                        try {
                            linkSpec.url = "geo:0,0?q=" + URLEncoder.encode(findAddress, C0700C.UTF8_NAME);
                            arrayList.add(linkSpec);
