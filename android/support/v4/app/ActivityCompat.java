...
public class ActivityCompat extends ContextCompat {
    ...
    private static class SharedElementCallback23Impl extends SharedElementCallback23 {
        ...
        class C00031 implements OnSharedElementsReadyListener {
            final /* synthetic */ OnSharedElementsReadyListenerBridge val$listener;

            C00031(OnSharedElementsReadyListenerBridge onSharedElementsReadyListenerBridge) {
        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, OnSharedElementsReadyListenerBridge onSharedElementsReadyListenerBridge) {
            this.mCallback.onSharedElementsArrived(list, list2, new C00031(onSharedElementsReadyListenerBridge));
        }
    }
    ...
    public static void requestPermissions(@NonNull Activity activity, @NonNull String[] strArr, int i) {
        if (VERSION.SDK_INT >= 23) {
            ...
            new Handler(Looper.getMainLooper()).post(new C00021(strArr, activity, i));
        }
    }
