...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00091 implements ThreadFactory {
    ...
    class C00102 extends WorkerRunnable<Params, Result> {
        C00102() {
        }
