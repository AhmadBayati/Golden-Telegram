...
public class FileProvider extends ContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) {
        ...
        XmlResourceParser loadXmlMetaData = context.getPackageManager().resolveContentProvider(str, TLRPC.USER_FLAG_UNUSED).loadXmlMetaData(context.getPackageManager(), META_DATA_FILE_PROVIDER_PATHS);
