...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C00611 extends Animation {
        ...
        public void applyTransformation(float f, Transformation transformation) {
            ...
            if (f > MaterialProgressDrawable.START_TRIM_DURATION_OFFSET) {
                this.val$ring.setEndTrim(((MaterialProgressDrawable.MAX_PROGRESS_ARC - minProgressArc) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((f - MaterialProgressDrawable.START_TRIM_DURATION_OFFSET) / MaterialProgressDrawable.START_TRIM_DURATION_OFFSET)) + startingEndTrim);
            }
    ...
    class C00622 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    class C00633 implements Callback {
        C00633() {
        }
    ...
    static {
        ...
        iArr[LARGE] = Theme.MSG_TEXT_COLOR;
        COLORS = iArr;
    }

    MaterialProgressDrawable(Context context, View view) {
        this.mAnimators = new ArrayList();
        this.mCallback = new C00633();
        this.mParent = view;
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        ...
        intValue &= NalUnitUtil.EXTENDED_SAR;
        int intValue2 = Integer.valueOf(i2).intValue();
        return (intValue + ((int) (((float) ((intValue2 & NalUnitUtil.EXTENDED_SAR) - intValue)) * f))) | ((((i3 + ((int) (((float) (((intValue2 >> 24) & NalUnitUtil.EXTENDED_SAR) - i3)) * f))) << 24) | ((i4 + ((int) (((float) (((intValue2 >> 16) & NalUnitUtil.EXTENDED_SAR) - i4)) * f))) << 16)) | ((((int) (((float) (((intValue2 >> 8) & NalUnitUtil.EXTENDED_SAR) - i5)) * f)) + i5) << 8));
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation c00611 = new C00611(ring);
        c00611.setRepeatCount(-1);
        c00611.setRepeatMode(DEFAULT);
        c00611.setInterpolator(LINEAR_INTERPOLATOR);
        c00611.setAnimationListener(new C00622(ring));
        this.mAnimation = c00611;
    }
