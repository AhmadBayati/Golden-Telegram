...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00691());
        }
    ...
    private void dimChildView(View view, float f, int i) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        if (f > 0.0f && i != 0) {
            int i2 = (((int) (((float) ((Theme.MSG_TEXT_COLOR & i) >>> 24)) * f)) << 24) | (ViewCompat.MEASURED_SIZE_MASK & i);
        ...
        while (i6 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    i8 = (int) ((DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - this.mSlideOffset) * ((float) this.mParallaxBy));
                    i10 = paddingRight;
                }
                if (isLayoutRtlSupport) {
                    i9 = (i5 - i10) + i8;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        } else if (mode == TLRPC.MESSAGE_FLAG_MEGAGROUP) {
            i3 = mode2;
            i4 = size;
            size = size2;
        } else {
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                mode = layoutParams.width == -2 ? MeasureSpec.makeMeasureSpec(paddingLeft - mode, TLRPC.MESSAGE_FLAG_MEGAGROUP) : layoutParams.width == -1 ? MeasureSpec.makeMeasureSpec(paddingLeft - mode, C0700C.ENCODING_PCM_32BIT) : MeasureSpec.makeMeasureSpec(layoutParams.width, C0700C.ENCODING_PCM_32BIT);
                i8 = layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(mode2, TLRPC.MESSAGE_FLAG_MEGAGROUP) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(mode2, C0700C.ENCODING_PCM_32BIT) : MeasureSpec.makeMeasureSpec(layoutParams.height, C0700C.ENCODING_PCM_32BIT);
                ...
                if (childAt2.getVisibility() != 8) {
                    ...
                    if (childAt2.getVisibility() != 8) {
                        ...
                        if (!z || childAt2 == this.mSlideableView) {
                            if (layoutParams.weight > 0.0f) {
                                mode = layoutParams.width == 0 ? layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(mode2, TLRPC.MESSAGE_FLAG_MEGAGROUP) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(mode2, C0700C.ENCODING_PCM_32BIT) : MeasureSpec.makeMeasureSpec(layoutParams.height, C0700C.ENCODING_PCM_32BIT) : MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), C0700C.ENCODING_PCM_32BIT);
                                if (z) {
                                    size2 = paddingLeft - (layoutParams.rightMargin + layoutParams.leftMargin);
                                    i5 = MeasureSpec.makeMeasureSpec(size2, C0700C.ENCODING_PCM_32BIT);
                                    if (i8 != size2) {
                                        childAt2.measure(i5, mode);
                                    }
                                } else {
                                    childAt2.measure(MeasureSpec.makeMeasureSpec(((int) ((layoutParams.weight * ((float) Math.max(0, i6))) / f)) + i8, C0700C.ENCODING_PCM_32BIT), mode);
                                }
                            }
                        } else if (layoutParams.width < 0 && (i8 > i9 || layoutParams.weight > 0.0f)) {
                            size2 = obj != null ? layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(mode2, TLRPC.MESSAGE_FLAG_MEGAGROUP) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(mode2, C0700C.ENCODING_PCM_32BIT) : MeasureSpec.makeMeasureSpec(layoutParams.height, C0700C.ENCODING_PCM_32BIT) : MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), C0700C.ENCODING_PCM_32BIT);
                            childAt2.measure(MeasureSpec.makeMeasureSpec(i9, C0700C.ENCODING_PCM_32BIT), size2);
                        }
                    }
                }
            }
