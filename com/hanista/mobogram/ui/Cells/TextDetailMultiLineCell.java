...
public class TextDetailMultiLineCell extends FrameLayout {
    ...
    public TextDetailMultiLineCell(Context context) {
        int i = 5;
        super(context);
        if (paint == null) {
            paint = new Paint();
        ...
        addView(view, LayoutHelper.createFrame(-2, -2.0f, i | 48, 17.0f, 40.0f, 17.0f, 0.0f));
    }
