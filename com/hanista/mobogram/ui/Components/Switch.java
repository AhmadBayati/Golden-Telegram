...
public class Switch extends CompoundButton {
    ...
    public static class Insets {
        ...
        static {
            NONE = new Insets(AndroidUtilities.dp(4.0f), 0, AndroidUtilities.dp(4.0f), 0);
        }
    ...
    public Switch(Context context) {
        ...
        this.mThumbDrawable = context.getResources().getDrawable(C0338R.drawable.switch_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = context.getResources().getDrawable(C0338R.drawable.switch_track);
    ...
    private void animateThumbToCheckedState(boolean z) {
        ...
        this.mPositionAnimator = ObjectAnimator.ofFloat(this, "thumbPosition", fArr);
    ...
    private int getThumbOffset() {
        return (int) (((LocaleController.isRTL ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT - this.thumbPosition : this.thumbPosition) * ((float) getThumbScrollRange())) + 0.5f);
    }
    ...
    private void initTheme(boolean z) {
        if (ThemeUtil.m2490b() && getTag() == null) {
            int i = AdvanceTheme.f2499j;
            int b = AdvanceTheme.m2284b(AdvanceTheme.f2499j, i, 0.5f);
            int a = AdvanceTheme.m2277a(AdvanceTheme.f2491b, -15684964, 0.5f);
            if (i != AdvanceTheme.f2491b) {
                a = b;
            }
            if (this.mTrackDrawable != null) {
            ...
            if (this.mThumbDrawable != null) {
                this.mThumbDrawable.setColorFilter(new PorterDuffColorFilter(z ? i : -1184275, Mode.MULTIPLY));
            }
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            i = AndroidUtilities.density == 1.5f ? AndroidUtilities.dp(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT) : 0;
            ...
            case TOUCH_MODE_DRAGGING /*2*/:
                switch (this.mTouchMode) {
                    ...
                    case TOUCH_MODE_DRAGGING /*2*/:
                        ...
                        x = thumbScrollRange != 0 ? f / ((float) thumbScrollRange) : f > 0.0f ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : Face.UNCOMPUTED_PROBABILITY;
                        if (LocaleController.isRTL) {
                            x = -x;
                        }
                        x = constrain(x + this.thumbPosition, 0.0f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    ...
    public void setChecked(boolean z) {
        ...
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setColorFilter(new PorterDuffColorFilter(isChecked ? ThemeUtil.m2485a().m2291e() : -3684409, Mode.MULTIPLY));
        }
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setColorFilter(new PorterDuffColorFilter(isChecked ? ThemeUtil.m2485a().m2289c() : -1184275, Mode.MULTIPLY));
        }
        initTheme(isChecked);
    }
    ...
    public void setColor(int i) {
        if (ThemeUtil.m2490b()) {
            ...
            int a = AdvanceTheme.m2277a(AdvanceTheme.f2491b, -15684964, 0.5f);
            int b = AdvanceTheme.m2283b(i, 127);
            if (i != i2) {
                a = b;
            }
            if (this.mTrackDrawable != null) {
