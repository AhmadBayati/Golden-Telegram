...
public class TextPaintView extends EntityView {
    ...
    /* renamed from: com.hanista.mobogram.ui.Components.Paint.Views.TextPaintView.1 */
    class C13871 implements TextWatcher {
    ...
    public class TextViewSelectionView extends SelectionView {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float dp3 = (float) AndroidUtilities.dp(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    ...
    public TextPaintView(Context context, Point point, int i, String str, Swatch swatch, boolean z) {
        ...
        setStroke(z);
        updatePosition();
        this.editText.addTextChangedListener(new C13871());
    }
    ...
    protected Rect getSelectionBounds() {
        ...
        return new Rect((this.position.f2683x - (width / 2.0f)) * scaleX, (this.position.f2684y - (height / 2.0f)) * scaleX, width * scaleX, scaleX * height);
    }
