...
public class Shader {
    ...
    public Shader(String str, String str2, String[] strArr, String[] strArr2) {
        ...
        if (compileShader.status == 0) {
            FileLog.m16e("tmessages", "Vertex shader compilation failed");
        ...
        if (compileShader2.status == 0) {
            FileLog.m16e("tmessages", "Fragment shader compilation failed");
    ...
    private int linkProgram(int i) {
        ...
        if (iArr[0] == 0) {
            FileLog.m16e("tmessages", GLES20.glGetProgramInfoLog(i));
        }
        return iArr[0];
    }
