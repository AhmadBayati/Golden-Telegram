...
public class Painting {
    ...
    /* renamed from: com.hanista.mobogram.ui.Components.Paint.Painting.1 */
    class C13661 implements Runnable {
        final /* synthetic */ Runnable val$action;
        final /* synthetic */ boolean val$clearBuffer;
        final /* synthetic */ Path val$path;

        C13661(Path path, boolean z, Runnable runnable) {
            this.val$path = path;
            this.val$clearBuffer = z;
            ...
            if (GLES20.glCheckFramebufferStatus(36160) == 36053) {
                ...
                if (Painting.this.shaders != null) {
                    ...
                    if (shader != null) {
                        ...
                        rectF = Render.RenderPath(this.val$path, Painting.this.renderState);
                    } else {
                        return;
                    }
                }
    ...
    /* renamed from: com.hanista.mobogram.ui.Components.Paint.Painting.2 */
    class C13682 implements Runnable {
        final /* synthetic */ int val$color;

        /* renamed from: com.hanista.mobogram.ui.Components.Paint.Painting.2.1 */
            ...
            public void run() {
                if (Painting.this.shaders != null) {
                    ...
                    if (shader != null) {
                        ...
                        Shader.SetColorUniform(shader.getUniform(TtmlNode.ATTR_TTS_COLOR), C13682.this.val$color);
                        GLES20.glActiveTexture(33984);
        ...
        public void run() {
            ...
            Painting.this.update(null, new C13671());
    ...
    /* renamed from: com.hanista.mobogram.ui.Components.Paint.Painting.3 */
    class C13693 implements Runnable {
        final /* synthetic */ Slice val$slice;
    ...
    /* renamed from: com.hanista.mobogram.ui.Components.Paint.Painting.4 */
    class C13704 implements Runnable {
        final /* synthetic */ Slice val$slice;
        ...
        public void run() {
            Buffer data = this.val$slice.getData();
            GLES20.glBindTexture(3553, Painting.this.getTexture());
            GLES20.glTexSubImage2D(3553, 0, this.val$slice.getX(), this.val$slice.getY(), this.val$slice.getWidth(), this.val$slice.getHeight(), 6408, 5121, data);
    ...
    /* renamed from: com.hanista.mobogram.ui.Components.Paint.Painting.5 */
    class C13715 implements Runnable {
        final /* synthetic */ Runnable val$completionRunnable;

        C13715(Runnable runnable) {
    ...
    public Painting(Size size) {
        ...
        this.projection = GLMatrix.LoadOrtho(0.0f, this.size.width, 0.0f, this.size.height, Face.UNCOMPUTED_PROBABILITY, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    ...
    private void registerUndo(RectF rectF) {
        if (rectF != null && rectF.setIntersect(rectF, getBounds())) {
            this.delegate.requestUndoStore().registerUndo(UUID.randomUUID(), new C13693(new Slice(getPaintingData(rectF, true).data, rectF, this.delegate.requestDispatchQueue())));
        }
    }
    ...
    private void restoreSlice(Slice slice) {
        this.renderView.performInContext(new C13704(slice));
    }
    ...
    public void commitStroke(int i) {
        this.renderView.performInContext(new C13682(i));
    }
    ...
    public void onPause(Runnable runnable) {
        this.renderView.performInContext(new C13715(runnable));
    }
    ...
    public void paintStroke(Path path, boolean z, Runnable runnable) {
        this.renderView.performInContext(new C13661(path, z, runnable));
    }
