...
public class SerializedData extends AbstractSerializedData {
    ...
    public byte[] readByteArray(boolean z) {
        ...
        try {
            ...
            this.len++;
            for (i = 
            /* Method generation error in method: com.hanista.mobogram.tgnet.SerializedData.readByteArray(boolean):byte[]
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r1_10 'i' int) = (r1_9 'i' int), (r1_0 'i' int) binds: {(r1_0 'i' int)=B:15:0x0069, (r1_9 'i' int)=B:4:0x0011} in method: com.hanista.mobogram.tgnet.SerializedData.readByteArray(boolean):byte[]
...
Caused by: jadx.core.utils.exceptions.CodegenException: Unknown instruction: PHI in method: com.hanista.mobogram.tgnet.SerializedData.readByteArray(boolean):byte[]
 ...
 */
            ...
            public void readBytes(byte[] bArr, boolean z) {
                try {
                    ...
                    FileLog.m16e("tmessages", "read bytes error");
                }
            }
            ...
            public String readString(boolean z) {
                try {
                    ...
                    this.len++;
                    for (read = 
                    /* Method generation error in method: com.hanista.mobogram.tgnet.SerializedData.readString(boolean):java.lang.String
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r0_7 'read' int) = (r0_6 'read' int), (r0_11 'read' int) binds: {(r0_6 'read' int)=B:4:0x0011, (r0_11 'read' int)=B:15:0x0074} in method: com.hanista.mobogram.tgnet.SerializedData.readString(boolean):java.lang.String
	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:225)
	at jadx.core.codegen.RegionGen.makeLoop(RegionGen.java:184)
	at jadx.core.codegen.RegionGen.makeRegion(RegionGen.java:61)
	at jadx.core.codegen.RegionGen.makeSimpleRegion(RegionGen.java:87)
	...
	at jadx.api.JavaClass.decompile(JavaClass.java:59)
	at jadx.api.JadxDecompiler$1.run(JadxDecompiler.java:161)
Caused by: jadx.core.utils.exceptions.CodegenException: Unknown instruction: PHI in method: com.hanista.mobogram.tgnet.SerializedData.readString(boolean):java.lang.String
	at jadx.core.codegen.InsnGen.makeInsnBody(InsnGen.java:512)
	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:219)
	... 20 more
 */
                    ...
                    public void writeBytes(byte[] bArr, int i, int i2) {
                        try {
                            ...
                            FileLog.m16e("tmessages", "write bytes error");
                        }
                    }
