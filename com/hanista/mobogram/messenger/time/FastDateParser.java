...
public class FastDateParser implements DateParser, Serializable {
    ...
    /* renamed from: com.hanista.mobogram.messenger.time.FastDateParser.1 */
    static class C08831 extends NumberStrategy {
        C08831(int i) {
            super(i);
        }
    ...
    /* renamed from: com.hanista.mobogram.messenger.time.FastDateParser.2 */
    static class C08842 extends NumberStrategy {
        C08842(int i) {
            super(i);
        }
    ...
    /* renamed from: com.hanista.mobogram.messenger.time.FastDateParser.3 */
    static class C08853 extends NumberStrategy {
        C08853(int i) {
            super(i);
        }
    ...
    /* renamed from: com.hanista.mobogram.messenger.time.FastDateParser.4 */
    static class C08864 extends NumberStrategy {
        C08864(int i) {
            super(i);
        }
    ...
    private static class TimeZoneStrategy extends Strategy {
        ...
        TimeZoneStrategy(Locale locale) {
            ...
            for (int i = ID; i < length; i += LONG_STD) {
                Object[] objArr = zoneStrings[i];
                if (!objArr[ID].startsWith("GMT")) {
                    TimeZone timeZone = TimeZone.getTimeZone(objArr[ID]);
                    if (!this.tzNames.containsKey(objArr[LONG_STD])) {
                        this.tzNames.put(objArr[LONG_STD], timeZone);
                    }
                    if (!this.tzNames.containsKey(objArr[SHORT_STD])) {
                        this.tzNames.put(objArr[SHORT_STD], timeZone);
                    }
                    if (timeZone.useDaylightTime()) {
                        if (!this.tzNames.containsKey(objArr[LONG_DST])) {
                            this.tzNames.put(objArr[LONG_DST], timeZone);
                        }
                        if (!this.tzNames.containsKey(objArr[SHORT_DST])) {
                            this.tzNames.put(objArr[SHORT_DST], timeZone);
                        }
                    }
                }
            }
    ...
    static {
        ...
        ABBREVIATED_YEAR_STRATEGY = new C08831(1);
        NUMBER_MONTH_STRATEGY = new C08842(2);
        ...
        MODULO_HOUR_OF_DAY_STRATEGY = new C08853(11);
        MODULO_HOUR_STRATEGY = new C08864(10);
    ...
    L_0x0054:
        ...
        goto L_0x0017;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hanista.mobogram.messenger.time.FastDateParser.escapeRegex(java.lang.StringBuilder, java.lang.String, boolean):java.lang.StringBuilder");
    }
