...
public class OutputSurface implements OnFrameAvailableListener {
    ...
    public OutputSurface(int i, int i2, int i3) {
        ...
        this.mPixelBuf = ByteBuffer.allocateDirect((this.mWidth * this.mHeight) * EGL_OPENGL_ES2_BIT);
    ...
    private void eglSetup(int i, int i2) {
        ...
        if (this.mEGLDisplay == EGL10.EGL_NO_DISPLAY) {
            ...
            if (this.mEGL.eglChooseConfig(this.mEGLDisplay, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12339, 1, 12352, EGL_OPENGL_ES2_BIT, 12344}, eGLConfigArr, eGLConfigArr.length, new int[1])) {
