...
public class MP4Builder {
    ...
    protected void createStsc(Track track, SampleTableBox sampleTableBox) {
        ...
        while (i4 < size) {
            ...
            if (obj != null) {
                if (i3 != i2) {
                    sampleToChunkBox.getEntries().add(new Entry((long) i, (long) i2, 1));
                    i5 = i2;
                } else {
                    i5 = i3;
                }
    ...
    protected void createStts(Track track, SampleTableBox sampleTableBox) {
        ...
        while (it.hasNext()) {
            TimeToSampleBox.Entry entry2;
            long longValue = ((Long) it.next()).longValue();
            if (entry == null || entry.getDelta() != longValue) {
                entry2 = new TimeToSampleBox.Entry(1, longValue);
    ...
    protected TrackBox createTrackBox(Track track, Mp4Movie mp4Movie) {
        ...
        Object trackHeaderBox = new TrackHeaderBox();
        ...
        mediaHeaderBox.addBox(track.getMediaHeaderBox());
        handlerBox = new DataInformationBox();
        Object dataReferenceBox = new DataReferenceBox();
        handlerBox.addBox(dataReferenceBox);
        Box dataEntryUrlBox = new DataEntryUrlBox();
        dataEntryUrlBox.setFlags(1);
        dataReferenceBox.addBox(dataEntryUrlBox);
        mediaHeaderBox.addBox(handlerBox);
        mediaHeaderBox.addBox(createStbl(track));
        mediaBox.addBox(mediaHeaderBox);
        return trackBox;
    }
