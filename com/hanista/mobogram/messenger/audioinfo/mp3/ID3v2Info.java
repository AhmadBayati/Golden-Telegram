...
public class ID3v2Info extends AudioInfo {
    ...
    public ID3v2Info(java.io.InputStream r10, java.util.logging.Level r11) {
...
*/
        ...
        r9.<init>();
        r9.debugLevel = r11;
        r0 = isID3v2StartPosition(r10);
        if (r0 == 0) goto L_0x0069;
    L_0x000e:
        r1 = new com.hanista.mobogram.messenger.audioinfo.mp3.ID3v2TagHeader;
        r1.<init>(r10);
        r0 = "ID3";
        r9.brand = r0;
        r0 = "2.%d.%d";
        ...
        r2 = r1.tagBody(r10);
    L_0x003b:
        r4 = r2.getRemainingLength();	 Catch:{ ID3v2Exception -> 0x0088 }
        r6 = 10;	 Catch:{ ID3v2Exception -> 0x0088 }
        r0 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1));	 Catch:{ ID3v2Exception -> 0x0088 }
        if (r0 <= 0) goto L_0x0050;	 Catch:{ ID3v2Exception -> 0x0088 }
    L_0x0045:
        r0 = new com.hanista.mobogram.messenger.audioinfo.mp3.ID3v2FrameHeader;	 Catch:{ ID3v2Exception -> 0x0088 }
        r0.<init>(r2);	 Catch:{ ID3v2Exception -> 0x0088 }
        r3 = r0.isPadding();	 Catch:{ ID3v2Exception -> 0x0088 }
        if (r3 == 0) goto L_0x006a;
    L_0x0050:
        r0 = r2.getData();
        r2 = r2.getRemainingLength();
        r0.skipFully(r2);
        r0 = r1.getFooterSize();
        if (r0 <= 0) goto L_0x0069;
    L_0x0061:
    ...
    L_0x0069:
        return;
    L_0x006a:
        r3 = r0.getBodySize();	 Catch:{ ID3v2Exception -> 0x0088 }
        r4 = (long) r3;	 Catch:{ ID3v2Exception -> 0x0088 }
        r6 = r2.getRemainingLength();	 Catch:{ ID3v2Exception -> 0x0088 }
        r3 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1));	 Catch:{ ID3v2Exception -> 0x0088 }
        if (r3 <= 0) goto L_0x00af;	 Catch:{ ID3v2Exception -> 0x0088 }
    L_0x0077:
        r0 = LOGGER;	 Catch:{ ID3v2Exception -> 0x0088 }
        r0 = r0.isLoggable(r11);	 Catch:{ ID3v2Exception -> 0x0088 }
        if (r0 == 0) goto L_0x0050;	 Catch:{ ID3v2Exception -> 0x0088 }
    L_0x007f:
        r0 = LOGGER;	 Catch:{ ID3v2Exception -> 0x0088 }
        r3 = "ID3 frame claims to extend frames area";	 Catch:{ ID3v2Exception -> 0x0088 }
        r0.log(r11, r3);	 Catch:{ ID3v2Exception -> 0x0088 }
        goto L_0x0050;
    L_0x0088:
        r0 = move-exception;
        r3 = LOGGER;
        r3 = r3.isLoggable(r11);
        if (r3 == 0) goto L_0x0050;
    L_0x0091:
        r3 = LOGGER;
        r4 = new java.lang.StringBuilder;
        r4.<init>();
        r5 = "ID3 exception occured: ";
        r4 = r4.append(r5);
        r0 = r0.getMessage();
        r0 = r4.append(r0);
        r0 = r0.toString();
        ...
        goto L_0x0050;
    L_0x00af:
        r3 = r0.isValid();	 Catch:{ ID3v2Exception -> 0x0088 }
        if (r3 == 0) goto L_0x010f;	 Catch:{ ID3v2Exception -> 0x0088 }
    L_0x00b5:
        r3 = r0.isEncryption();	 Catch:{ ID3v2Exception -> 0x0088 }
        if (r3 != 0) goto L_0x010f;	 Catch:{ ID3v2Exception -> 0x0088 }
    L_0x00bb:
        r3 = r2.frameBody(r0);	 Catch:{ ID3v2Exception -> 0x0088 }
        r9.parseFrame(r3);	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
        r0 = r3.getData();
        r4 = r3.getRemainingLength();
        r0.skipFully(r4);
        goto L_0x003b;
    L_0x00cf:
        r4 = move-exception;
        r5 = LOGGER;	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
        r5 = r5.isLoggable(r11);	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
    ...
    L_0x00d8:
        ...
        r0 = r0.getFrameId();	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
        r7[r8] = r0;	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
        r0 = 1;	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
        r4 = r4.getMessage();	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
        r7[r0] = r4;	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
        r0 = java.lang.String.format(r6, r7);	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
        r5.log(r11, r0);	 Catch:{ ID3v2Exception -> 0x00cf, all -> 0x0102 }
    L_0x00f5:
        r0 = r3.getData();
        r4 = r3.getRemainingLength();
        r0.skipFully(r4);
    ...
    L_0x0102:
        r0 = move-exception;	 Catch:{ ID3v2Exception -> 0x0088 }
        r4 = r3.getData();	 Catch:{ ID3v2Exception -> 0x0088 }
        r6 = r3.getRemainingLength();	 Catch:{ ID3v2Exception -> 0x0088 }
        r4.skipFully(r6);	 Catch:{ ID3v2Exception -> 0x0088 }
        throw r0;	 Catch:{ ID3v2Exception -> 0x0088 }
    L_0x010f:
        r3 = r2.getData();	 Catch:{ ID3v2Exception -> 0x0088 }
        r0 = r0.getBodySize();	 Catch:{ ID3v2Exception -> 0x0088 }
        r4 = (long) r0;	 Catch:{ ID3v2Exception -> 0x0088 }
        r3.skipFully(r4);	 Catch:{ ID3v2Exception -> 0x0088 }
        goto L_0x003b;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hanista.mobogram.messenger.audioinfo.mp3.ID3v2Info.<init>(java.io.InputStream, java.util.logging.Level):void");
    }
    ...
    void parseFrame(com.hanista.mobogram.messenger.audioinfo.mp3.ID3v2FrameBody r10) {
        /*
        r9 = this;
    ...
    L_0x02dc:
        ...
        r0 = com.hanista.mobogram.messenger.audioinfo.mp3.ID3v1Genre.getGenre(r0);	 Catch:{ NumberFormatException -> 0x0305 }
    ...
    L_0x0563:
        ...
        goto L_0x0047;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hanista.mobogram.messenger.audioinfo.mp3.ID3v2Info.parseFrame(com.hanista.mobogram.messenger.audioinfo.mp3.ID3v2FrameBody):void");
    }
