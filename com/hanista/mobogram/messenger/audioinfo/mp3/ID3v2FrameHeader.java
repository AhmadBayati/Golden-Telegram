...
public class ID3v2FrameHeader {
    ...
    public ID3v2FrameHeader(ID3v2TagBody iD3v2TagBody) {
        ...
        if (iD3v2TagBody.getTagHeader().getVersion() == 2) {
            this.bodySize = (((data.readByte() & NalUnitUtil.EXTENDED_SAR) << 16) | ((data.readByte() & NalUnitUtil.EXTENDED_SAR) << 8)) | (data.readByte() & NalUnitUtil.EXTENDED_SAR);
