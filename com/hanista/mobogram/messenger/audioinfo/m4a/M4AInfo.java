...
public class M4AInfo extends AudioInfo {
    ...
    static {
        LOGGER = Logger.getLogger(M4AInfo.class.getName());
    }
    ...
    void data(com.hanista.mobogram.messenger.audioinfo.m4a.MP4Atom r9) {
        /*
        r8 = this;
    ...
    L_0x0269:
        r0 = r9.readShort();
        r0 = r0 + -1;
        r0 = com.hanista.mobogram.messenger.audioinfo.mp3.ID3v1Genre.getGenre(r0);
        if (r0 == 0) goto L_0x0035;
    L_0x0275:
    ...
    L_0x02d4:
        ...
        goto L_0x0035;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hanista.mobogram.messenger.audioinfo.m4a.M4AInfo.data(com.hanista.mobogram.messenger.audioinfo.m4a.MP4Atom):void");
    }
