package com.hanista.mobogram.messenger.audioinfo;

import android.graphics.Bitmap;
import com.hanista.mobogram.messenger.audioinfo.m4a.M4AInfo;
import com.hanista.mobogram.messenger.audioinfo.mp3.MP3Info;
...
public abstract class AudioInfo {
    ...
    public static AudioInfo getAudioInfo(File file) {
        try {
            ...
            return (bArr[4] == 102 && bArr[5] == 116 && bArr[6] == 121 && bArr[7] == 112) ? new M4AInfo(bufferedInputStream) : new MP3Info(bufferedInputStream, file.length());
        } catch (Exception e) {
            return null;
        }
    }
