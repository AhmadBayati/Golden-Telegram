...
import com.hanista.mobogram.messenger.support.widget.helper.ItemTouchHelper.ViewDropHandler;
...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler {
    ...
    /* renamed from: com.hanista.mobogram.messenger.support.widget.LinearLayoutManager.1 */
    class C08581 extends LinearSmoothScroller {
    ...
    public static class SavedState implements Parcelable {
        ...
        /* renamed from: com.hanista.mobogram.messenger.support.widget.LinearLayoutManager.SavedState.1 */
        static class C08591 implements Creator<SavedState> {
            C08591() {
            }
    ...
    int fill(com.hanista.mobogram.messenger.support.widget.RecyclerView.Recycler r8, com.hanista.mobogram.messenger.support.widget.LinearLayoutManager.LayoutState r9, com.hanista.mobogram.messenger.support.widget.RecyclerView.State r10, boolean r11) {
        /*
        r7 = this;
    ...
    L_0x0016:
        ...
        r2 = r9.mExtra;
        r0 = r0 + r2;
        r2 = new com.hanista.mobogram.messenger.support.widget.LinearLayoutManager$LayoutChunkResult;
        r2.<init>();
    L_0x0020:
        r3 = r9.mInfinite;
    ...
    L_0x007e:
        goto L_0x0036;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hanista.mobogram.messenger.support.widget.LinearLayoutManager.fill(com.hanista.mobogram.messenger.support.widget.RecyclerView$Recycler, com.hanista.mobogram.messenger.support.widget.LinearLayoutManager$LayoutState, com.hanista.mobogram.messenger.support.widget.RecyclerView$State, boolean):int");
    }
    ...
    boolean shouldMeasureTwice() {
        return (getHeightMode() == C0700C.ENCODING_PCM_32BIT || getWidthMode() == C0700C.ENCODING_PCM_32BIT || !hasFlexibleChildInBothOrientations()) ? DEBUG : true;
    }

    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int i) {
        SmoothScroller c08581 = new C08581(recyclerView.getContext());
        c08581.setTargetPosition(i);
        startSmoothScroll(c08581);
    }
