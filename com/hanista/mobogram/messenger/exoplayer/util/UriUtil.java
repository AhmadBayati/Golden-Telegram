...
public final class UriUtil {
    ...
    public static String resolve(String str, String str2) {
        ...
        if (uriIndices[FRAGMENT] == 0) {
            return stringBuilder.append(charSequence, 0, uriIndices2[FRAGMENT]).append(str2).toString();
        }
        if (uriIndices[QUERY] == 0) {
            return stringBuilder.append(charSequence, 0, uriIndices2[QUERY]).append(str2).toString();
        }
        int i;
        if (uriIndices[PATH] != 0) {
            ...
            stringBuilder.append(charSequence, 0, uriIndices2[PATH]).append(str2);
            ...
            i = charSequence.lastIndexOf(47, uriIndices2[QUERY] - 1);
            i = i == -1 ? uriIndices2[PATH] : i + PATH;
            stringBuilder.append(charSequence, 0, i).append(str2);
            return removeDotSegments(stringBuilder, uriIndices2[PATH], i + uriIndices[QUERY]);
        } else {
            stringBuilder.append(charSequence, 0, uriIndices2[PATH]).append('/').append(str2);
