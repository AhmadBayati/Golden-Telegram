...
public final class MpegAudioHeader {
    ...
    static {
        ...
        BITRATE_V1_L1 = new int[]{32, 64, 96, TLRPC.USER_FLAG_UNUSED, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, TLRPC.USER_FLAG_UNUSED2, 288, 320, 352, 384, 416, 448};
        BITRATE_V2_L1 = new int[]{32, 48, 56, 64, 80, 96, 112, TLRPC.USER_FLAG_UNUSED, 144, 160, 176, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, TLRPC.USER_FLAG_UNUSED2};
        BITRATE_V1_L2 = new int[]{32, 48, 56, 64, 80, 96, 112, TLRPC.USER_FLAG_UNUSED, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, TLRPC.USER_FLAG_UNUSED2, 320, 384};
        BITRATE_V1_L3 = new int[]{32, 40, 48, 56, 64, 80, 96, 112, TLRPC.USER_FLAG_UNUSED, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, TLRPC.USER_FLAG_UNUSED2, 320};
        BITRATE_V2 = new int[]{8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, TLRPC.USER_FLAG_UNUSED, 144, 160};
    }
    ...
    public static boolean populateHeader(int i, MpegAudioHeader mpegAudioHeader) {
        ...
        mpegAudioHeader.setValues(i3, str, i6, i9, i2, i7 * PointerIconCompat.TYPE_DEFAULT, i8);
        return true;
    }
