...
public final class MimeTypes {
    ...
    public static String getAudioMediaMimeType(String str) {
        ...
        for (String trim : str.split(",")) {
            ...
            if (trim2.startsWith(AudioSampleEntry.TYPE3)) {
                return AUDIO_AAC;
            }
            if (trim2.startsWith(AudioSampleEntry.TYPE8) || trim2.startsWith(AC3SpecificBox.TYPE)) {
                return AUDIO_AC3;
            }
            if (trim2.startsWith(AudioSampleEntry.TYPE9) || trim2.startsWith(EC3SpecificBox.TYPE)) {
                return AUDIO_E_AC3;
            }
            if (trim2.startsWith("dtsc")) {
                return AUDIO_DTS;
            }
            if (trim2.startsWith(AudioSampleEntry.TYPE12) || trim2.startsWith(AudioSampleEntry.TYPE11)) {
                return AUDIO_DTS_HD;
            }
            if (trim2.startsWith(AudioSampleEntry.TYPE13)) {
    ...
    public static String getVideoMediaMimeType(String str) {
        ...
        for (String trim : str.split(",")) {
            String trim2 = trim2.trim();
            if (trim2.startsWith(VisualSampleEntry.TYPE3) || trim2.startsWith(VisualSampleEntry.TYPE4)) {
                return VIDEO_H264;
            }
            if (trim2.startsWith(VisualSampleEntry.TYPE7) || trim2.startsWith(VisualSampleEntry.TYPE6)) {
                return VIDEO_H265;
            }
