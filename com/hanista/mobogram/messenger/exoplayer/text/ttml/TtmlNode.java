...
final class TtmlNode {
    ...
    public List<Cue> getCues(long j, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2) {
        ...
        for (Entry entry : treeMap.entrySet()) {
            ...
            arrayList.add(new Cue(cleanUpText((SpannableStringBuilder) entry.getValue()), null, ttmlRegion.line, ttmlRegion.lineType, TLRPC.MESSAGE_FLAG_MEGAGROUP, ttmlRegion.position, TLRPC.MESSAGE_FLAG_MEGAGROUP, ttmlRegion.width));
        }
        return arrayList;
    }
