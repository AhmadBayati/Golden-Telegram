...
abstract class Atom {
    ...
    static final class ContainerAtom extends Atom {
        ...
        public int getChildAtomOfTypeCount(int i) {
            ...
            int i4 = 0;
            while (i3 < size) {
                int i5 = ((LeafAtom) this.leafChildren.get(i3)).type == i ? i4 + Atom.LONG_SIZE_PREFIX : i4;
                i3 += Atom.LONG_SIZE_PREFIX;
                i4 = i5;
            }
            i3 = this.containerChildren.size();
            while (i2 < i3) {
                i5 = ((ContainerAtom) this.containerChildren.get(i2)).type == i ? i4 + Atom.LONG_SIZE_PREFIX : i4;
                i2 += Atom.LONG_SIZE_PREFIX;
                i4 = i5;
            }
            return i4;
        }
    ...
    static {
        ...
        TYPE_emsg = Util.getIntegerCodeForString(EventMessageBox.TYPE);
