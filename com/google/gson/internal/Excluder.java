...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    class C02861 extends TypeAdapter<T> {
        ...
        C02861(boolean z, boolean z2, Gson gson, TypeToken typeToken) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        return (excludeClass || excludeClass2) ? new C02861(excludeClass2, excludeClass, gson, typeToken) : null;
    }
