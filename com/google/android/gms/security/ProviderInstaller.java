...
public class ProviderInstaller {
    ...
    class C02471 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener azX;
        final /* synthetic */ Context zzamt;

        C02471(Context context, ProviderInstallListener providerInstallListener) {
            this.zzamt = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener providerInstallListener) {
        ...
        new C02471(context, providerInstallListener).execute(new Void[0]);
    }

    private static void zzdy(Context context) {
