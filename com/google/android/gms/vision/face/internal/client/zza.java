...
public class zza extends com.google.android.gms.vision.internal.client.zza<zzd> {
    ...
    private Landmark zza(LandmarkParcel landmarkParcel) {
        return new Landmark(new PointF(landmarkParcel.f11x, landmarkParcel.f12y), landmarkParcel.type);
    }
    ...
    protected /* synthetic */ Object zzb(zzsu com_google_android_gms_internal_zzsu, Context context) {
    ...
    protected zzd zzc(zzsu com_google_android_gms_internal_zzsu, Context context) {
