...
public class GoogleCloudMessaging {
    ...
    private static final AtomicInteger aeV;
    private PendingIntent aeT;
    private Map<String, Handler> aeU;
    private final BlockingQueue<Intent> aeW;
    final Messenger aeX;
    private Context zzahn;

    /* renamed from: com.google.android.gms.gcm.GoogleCloudMessaging.1 */
    class C01201 extends Handler {
        final /* synthetic */ GoogleCloudMessaging aeY;

        C01201(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
            this.aeY = googleCloudMessaging;
            super(looper);
        }
    ...
    static {
        ...
        aeQ = 6500000;
        aeR = 7000000;
        aeV = new AtomicInteger(1);
    }

    public GoogleCloudMessaging() {
        this.aeW = new LinkedBlockingQueue();
        this.aeU = Collections.synchronizedMap(new HashMap());
        this.aeX = new Messenger(new C01201(this, Looper.getMainLooper()));
    }
    ...
    private String zzko(String str) {
        ...
        return InstanceID.getInstance(this.zzahn).zzbor().zzh(TtmlNode.ANONYMOUS_REGION_ID, str, INSTANCE_ID_SCOPE);
    }
