...
public abstract class Task implements Parcelable {
    ...
    Task(Parcel parcel) {
        ...
        this.afl = parcel.readInt() == NETWORK_STATE_UNMETERED;
        if (parcel.readInt() != NETWORK_STATE_UNMETERED) {
            z = false;
        }
        this.afm = z;
        this.afn = NETWORK_STATE_ANY;
        this.afo = false;
        this.afp = zzc.aff;
        this.mExtras = null;
    }
    ...
    public static void zza(zzc com_google_android_gms_gcm_zzc) {
        if (com_google_android_gms_gcm_zzc != null) {
            ...
            if (zzboc == NETWORK_STATE_UNMETERED || zzboc == 0) {
                ...
                } else if (zzboc == NETWORK_STATE_UNMETERED && zzbod < 10) {
    ...
    public void toBundle(Bundle bundle) {
        ...
        bundle.putString(NotificationCompatApi24.CATEGORY_SERVICE, this.afk);
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeInt(this.afl ? NETWORK_STATE_UNMETERED : NETWORK_STATE_CONNECTED);
        if (!this.afm) {
