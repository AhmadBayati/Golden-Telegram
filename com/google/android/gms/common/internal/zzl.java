...
public abstract class zzl<T extends IInterface> extends zze<T> implements zze, zza {
    ...
    class C01021 implements zzb {
        final /* synthetic */ ConnectionCallbacks Cq;

        C01021(ConnectionCallbacks connectionCallbacks) {
    ...
    class C01032 implements zzc {
        final /* synthetic */ OnConnectionFailedListener Cr;

        C01032(OnConnectionFailedListener onConnectionFailedListener) {
    ...
    private static zzb zza(ConnectionCallbacks connectionCallbacks) {
        return connectionCallbacks == null ? null : new C01021(connectionCallbacks);
    }

    @Nullable
    private static zzc zza(OnConnectionFailedListener onConnectionFailedListener) {
        return onConnectionFailedListener == null ? null : new C01032(onConnectionFailedListener);
    }
