...
final class zzo extends zzn implements Callback {
    ...
    private static final class zza {
        ...
        public boolean equals(Object obj) {
            ...
            return zzab.equal(this.f9V, com_google_android_gms_common_internal_zzo_zza.f9V) && zzab.equal(this.CF, com_google_android_gms_common_internal_zzo_zza.CF);
        }

        public int hashCode() {
            return zzab.hashCode(this.f9V, this.CF);
        }

        public String toString() {
            return this.f9V == null ? this.CF.flattenToString() : this.f9V;
        }

        public Intent zzauv() {
            return this.f9V != null ? new Intent(this.f9V).setPackage(this.CE) : new Intent().setComponent(this.CF);
        }
    }
