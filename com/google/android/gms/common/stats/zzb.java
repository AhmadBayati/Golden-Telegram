...
public class zzb {
    ...
    private zzb() {
        ...
        this.Ec = new zze(TLRPC.MESSAGE_FLAG_HAS_VIEWS, ((Long) zza.Em.get()).longValue());
        this.Ee = new zze(TLRPC.MESSAGE_FLAG_HAS_VIEWS, ((Long) zza.Em.get()).longValue());
    }
    ...
    private static ServiceInfo zzd(Context context, Intent intent) {
        List<ResolveInfo> queryIntentServices = context.getPackageManager().queryIntentServices(intent, TLRPC.USER_FLAG_UNUSED);
