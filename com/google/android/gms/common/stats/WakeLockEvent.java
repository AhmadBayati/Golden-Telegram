...
public final class WakeLockEvent extends StatsEvent {
    ...
    public String zzawt() {
        ...
        String join = zzaxa() == null ? TtmlNode.ANONYMOUS_REGION_ID : TextUtils.join(",", zzaxa());
        String valueOf5 = String.valueOf("\t");
        int zzaxb = zzaxb();
        String valueOf6 = String.valueOf("\t");
        String zzawx = zzawx() == null ? TtmlNode.ANONYMOUS_REGION_ID : zzawx();
        String valueOf7 = String.valueOf("\t");
        String zzaxc = zzaxc() == null ? TtmlNode.ANONYMOUS_REGION_ID : zzaxc();
        String valueOf8 = String.valueOf("\t");
        float zzaxd = zzaxd();
        String valueOf9 = String.valueOf("\t");
        String zzawy = zzawy() == null ? TtmlNode.ANONYMOUS_REGION_ID : zzawy();
