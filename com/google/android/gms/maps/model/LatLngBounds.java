...
public final class LatLngBounds extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public Builder() {
            this.amQ = Double.POSITIVE_INFINITY;
            this.amR = Double.NEGATIVE_INFINITY;
            this.amS = Double.NaN;
            this.amT = Double.NaN;
        }
    ...
    public static LatLngBounds createFromAttributes(Context context, AttributeSet attributeSet) {
        ...
        Float valueOf = obtainAttributes.hasValue(C0083R.styleable.MapAttrs_latLngBoundsSouthWestLatitude) ? Float.valueOf(obtainAttributes.getFloat(C0083R.styleable.MapAttrs_latLngBoundsSouthWestLatitude, 0.0f)) : null;
        Float valueOf2 = obtainAttributes.hasValue(C0083R.styleable.MapAttrs_latLngBoundsSouthWestLongitude) ? Float.valueOf(obtainAttributes.getFloat(C0083R.styleable.MapAttrs_latLngBoundsSouthWestLongitude, 0.0f)) : null;
        Float valueOf3 = obtainAttributes.hasValue(C0083R.styleable.MapAttrs_latLngBoundsNorthEastLatitude) ? Float.valueOf(obtainAttributes.getFloat(C0083R.styleable.MapAttrs_latLngBoundsNorthEastLatitude, 0.0f)) : null;
        Float valueOf4 = obtainAttributes.hasValue(C0083R.styleable.MapAttrs_latLngBoundsNorthEastLongitude) ? Float.valueOf(obtainAttributes.getFloat(C0083R.styleable.MapAttrs_latLngBoundsNorthEastLongitude, 0.0f)) : null;
