...
public final class zzari {
    ...
    static {
        UTF_8 = Charset.forName(C0700C.UTF8_NAME);
    ...
    public static void zza(zzare com_google_android_gms_internal_zzare, zzare com_google_android_gms_internal_zzare2) {
        if (com_google_android_gms_internal_zzare.bqv != null) {
            com_google_android_gms_internal_zzare2.bqv = (zzarg) com_google_android_gms_internal_zzare.bqv.clone();
        }
    }
