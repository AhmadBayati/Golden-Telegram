...
public class zzapy implements Closeable {
    ...
    /* renamed from: com.google.android.gms.internal.zzapy.1 */
    static class C01801 extends zzapd {
        C01801() {
        }

        public void zzi(zzapy com_google_android_gms_internal_zzapy) {
    ...
    static {
        bnX = ")]}'\n".toCharArray();
        zzapd.blQ = new C01801();
    }

    public zzapy(Reader reader) {
        this.bnY = false;
        this.bnZ = new char[TLRPC.MESSAGE_FLAG_HAS_VIEWS];
        this.pos = 0;
        this.limit = 0;
        this.boa = 0;
        this.bob = 0;
