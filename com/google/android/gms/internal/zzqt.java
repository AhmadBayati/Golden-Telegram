...
public class zzqt implements Callback {
    ...
    private class zzc<O extends ApiOptions> implements ConnectionCallbacks, OnConnectionFailedListener, zzqg {
        ...
        private final SparseArray<Map<com.google.android.gms.internal.zzrd.zzb<?>, zzri>> wg;
        private boolean xR;
        final /* synthetic */ zzqt yE;
        ...
        /* renamed from: com.google.android.gms.internal.zzqt.zzc.1 */
        class C01981 implements zzc {
            final /* synthetic */ int yL;
            final /* synthetic */ zzc yM;

            C01981(zzc com_google_android_gms_internal_zzqt_zzc, int i) {
                this.yM = com_google_android_gms_internal_zzqt_zzc;
                this.yL = i;
            }

            public void zzask() {
                if (this.yM.yG.isEmpty()) {
                    this.yM.zzf(this.yL, false);
                }
            }
        }
        ...
        public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
            ...
            synchronized (zzqt.zzaok) {
                if (null == null || !this.yE.yA.contains(this.vx)) {
                    if (!this.yE.zzc(connectionResult, keyAt)) {
        ...
        public void zzfx(int i) {
            ((zzrq) this.yI.get(i)).zza(new C01981(this, i));
        }
    }
