...
public class zzafz {
    ...
    /* renamed from: com.google.android.gms.internal.zzafz.1 */
    class C01291 extends Thread {
        final /* synthetic */ ContentResolver aRZ;

        /* renamed from: com.google.android.gms.internal.zzafz.1.1 */
        class C01281 extends ContentObserver {
            final /* synthetic */ C01291 aSa;

            C01281(C01291 c01291, Handler handler) {
                this.aSa = c01291;
                super(handler);
            }
        ...
        C01291(String str, ContentResolver contentResolver) {
        ...
        public void run() {
            Looper.prepare();
            this.aRZ.registerContentObserver(zzafz.CONTENT_URI, true, new C01281(this, new Handler(Looper.myLooper())));
            Looper.loop();
        }
    }
    ...
    private static void zza(ContentResolver contentResolver) {
        if (aRW == null) {
            aRW = new HashMap();
            aRX = new Object();
            new C01291("Gservices", contentResolver).start();
        }
    }
