...
final class zzaos<T> extends zzaot<T> {
    ...
    private static class zza implements zzaou {
        ...
        public <T> zzaot<T> zza(zzaob com_google_android_gms_internal_zzaob, zzapx<T> com_google_android_gms_internal_zzapx_T) {
            ...
            return isAssignableFrom ? new zzaos(this.blk, com_google_android_gms_internal_zzaob, com_google_android_gms_internal_zzapx_T, this, null) : null;
        }
    }
    ...
    public static zzaou zza(zzapx<?> com_google_android_gms_internal_zzapx_, Object obj) {
        return new zza(com_google_android_gms_internal_zzapx_, false, null, null);
    }

    public static zzaou zzb(zzapx<?> com_google_android_gms_internal_zzapx_, Object obj) {
        return new zza(com_google_android_gms_internal_zzapx_, com_google_android_gms_internal_zzapx_.bz() == com_google_android_gms_internal_zzapx_.by(), null, null);
    }
