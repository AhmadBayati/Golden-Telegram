...
public class zzrq {
    ...
    class C02031 implements zzb {
        final /* synthetic */ zzrq zx;

        C02031(zzrq com_google_android_gms_internal_zzrq) {
            this.zx = com_google_android_gms_internal_zzrq;
        }
    ...
    private static void zza(zzqe<?> com_google_android_gms_internal_zzqe_, zzf com_google_android_gms_common_api_zzf, IBinder iBinder) {
        if (com_google_android_gms_internal_zzqe_.isReady()) {
            com_google_android_gms_internal_zzqe_.zza(new zza(com_google_android_gms_common_api_zzf, iBinder, null));
            ...
            zzb com_google_android_gms_internal_zzrq_zza = new zza(com_google_android_gms_common_api_zzf, iBinder, null);
