...
public final class zzapf<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    /* renamed from: com.google.android.gms.internal.zzapf.1 */
    static class C01531 implements Comparator<Comparable> {
        C01531() {
        }
    ...
    class zza extends AbstractSet<Entry<K, V>> {
        ...
        /* renamed from: com.google.android.gms.internal.zzapf.zza.1 */
        class C01541 extends zzc<Entry<K, V>> {
            final /* synthetic */ zza blX;

            C01541(zza com_google_android_gms_internal_zzapf_zza) {
                this.blX = com_google_android_gms_internal_zzapf_zza;
                super(null);
            }
    ...
    final class zzb extends AbstractSet<K> {
        ...
        /* renamed from: com.google.android.gms.internal.zzapf.zzb.1 */
        class C01551 extends zzc<K> {
            final /* synthetic */ zzb blY;

            C01551(zzb com_google_android_gms_internal_zzapf_zzb) {
                this.blY = com_google_android_gms_internal_zzapf_zzb;
                super(null);
            }
