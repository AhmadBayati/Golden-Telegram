...
public class zzrp<R extends Result> extends TransformedResult<R> implements ResultCallback<R> {
    ...
    /* renamed from: com.google.android.gms.internal.zzrp.1 */
    class C02021 implements Runnable {
        final /* synthetic */ Result zr;
        final /* synthetic */ zzrp zs;

        C02021(zzrp com_google_android_gms_internal_zzrp, Result result) {
        ...
        public void run() {
            ...
            try {
                ...
                this.zs.zp.sendMessage(this.zs.zp.obtainMessage(0, this.zs.zk.onSuccess(this.zr)));
    ...
    public void onResult(R r) {
        synchronized (this.wG) {
            if (!r.getStatus().isSuccess()) {
                ...
                zzrj.zzarz().submit(new C02021(this, r));
            } else if (zzasv()) {
                this.zm.onSuccess(r);
            }
        }
