...
public final class zzapi {
    ...
    public static void zzb(zzaoh com_google_android_gms_internal_zzaoh, zzaqa com_google_android_gms_internal_zzaqa) {
        zzapw.bnH.zza(com_google_android_gms_internal_zzaqa, com_google_android_gms_internal_zzaoh);
    }

    public static zzaoh zzh(zzapy com_google_android_gms_internal_zzapy) {
        Object obj = 1;
        try {
