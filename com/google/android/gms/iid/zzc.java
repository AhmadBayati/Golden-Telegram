...
public class zzc {
    ...
    class C01271 extends Handler {
        final /* synthetic */ zzc agv;

        C01271(zzc com_google_android_gms_iid_zzc, Looper looper) {
            this.agv = com_google_android_gms_iid_zzc;
            super(looper);
        }
    ...
    static String zza(KeyPair keyPair, String... strArr) {
        String str = null;
        try {
            byte[] bytes = TextUtils.join("\n", strArr).getBytes(C0700C.UTF8_NAME);
            try {
    ...
    private void zzkp(String str) {
        if ("com.google.android.gsf".equals(agj)) {
            ...
            if (this.ags >= 3) {
                if (this.ags == 3) {
                    this.agt = new Random().nextInt(PointerIconCompat.TYPE_DEFAULT) + PointerIconCompat.TYPE_DEFAULT;
                }
                this.agt *= 2;
    ...
    void zzbou() {
        if (this.aeX == null) {
            zzdj(this.zzahn);
            this.aeX = new Messenger(new C01271(this, Looper.getMainLooper()));
        }
    }
    ...
    void zzu(Intent intent) {
        ...
        if (longExtra > 0) {
            ...
            this.agt = ((int) longExtra) * PointerIconCompat.TYPE_DEFAULT;
            this.agu = SystemClock.elapsedRealtime() + ((long) this.agt);
