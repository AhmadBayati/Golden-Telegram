...
public class InstanceID {
    ...
    static Map<String, InstanceID> afS;
    ...
    protected InstanceID(Context context, String str, Bundle bundle) {
        this.afW = TtmlNode.ANONYMOUS_REGION_ID;
    ...
    public void zzb(String str, String str2, Bundle bundle) {
        ...
        bundle.putString("subtype", TtmlNode.ANONYMOUS_REGION_ID.equals(this.afW) ? str : this.afW);
        String str3 = "X-subtype";
        if (!TtmlNode.ANONYMOUS_REGION_ID.equals(this.afW)) {
            str = this.afW;
        }
    ...
    public String zzc(String str, String str2, Bundle bundle) {
        ...
        bundle.putString("sender", str);
        String str3 = TtmlNode.ANONYMOUS_REGION_ID.equals(this.afW) ? str : this.afW;
