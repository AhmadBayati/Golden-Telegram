...
public class PlayReadyHeader extends ProtectionSpecificHeader {
    ...
    public ByteBuffer getData() {
        ...
        for (PlayReadyRecord value2 : this.records) {
            IsoTypeWriter.writeUInt16BE(allocate, value2.type);
            IsoTypeWriter.writeUInt16BE(allocate, value2.getValue().limit());
            allocate.put(value2.getValue());
        }
        return allocate;
    }
