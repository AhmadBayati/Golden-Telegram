...
public class VUIParameters {
    ...
    public static class BitstreamRestriction {
        ...
        public String toString() {
            ...
            stringBuilder.append("motion_vectors_over_pic_boundaries_flag=").append(this.motion_vectors_over_pic_boundaries_flag);
            stringBuilder.append(", max_bytes_per_pic_denom=").append(this.max_bytes_per_pic_denom);
            stringBuilder.append(", max_bits_per_mb_denom=").append(this.max_bits_per_mb_denom);
            stringBuilder.append(", log2_max_mv_length_horizontal=").append(this.log2_max_mv_length_horizontal);
            stringBuilder.append(", log2_max_mv_length_vertical=").append(this.log2_max_mv_length_vertical);
            stringBuilder.append(", num_reorder_frames=").append(this.num_reorder_frames);
            stringBuilder.append(", max_dec_frame_buffering=").append(this.max_dec_frame_buffering);
