...
public class AC3TrackImpl extends AbstractTrack {
    ...
    static {
        bitRateAndFrameSizeTable = (int[][][][]) Array.newInstance(Integer.TYPE, new int[]{19, 2, 3, 2});
        ...
        bitRateAndFrameSizeTable[4][0][0][1] = TLRPC.USER_FLAG_UNUSED;
        bitRateAndFrameSizeTable[4][1][0][1] = TLRPC.USER_FLAG_UNUSED;
        ...
        switch (readBits5) {
            ...
            case Method.PATCH /*7*/:
                ...
                if (readBits6 == 1) {
                    ...
                    aC3SpecificBox = new AC3SpecificBox();
    ...
    private List<Sample> readSamples() {
        ...
        while (-1 != this.dataSource.read(allocate)) {
            int frameSize = getFrameSize(allocate.get(4) & 63, allocate.get(4) >> 6);
            arrayList.add(new AnonymousClass1SampleImpl(this.dataSource.position() - 5, (long) frameSize, this.dataSource));
