...
public class AACTrackImpl extends AbstractTrack {
    ...
    /* renamed from: com.googlecode.mp4parser.authoring.tracks.AACTrackImpl.1 */
    class C03231 implements Sample {
        private final /* synthetic */ long val$currentPosition;
        private final /* synthetic */ long val$frameSize;

        C03231(long j, long j2) {
            this.val$currentPosition = j;
            this.val$frameSize = j2;
        }

        public ByteBuffer asByteBuffer() {
            try {
                return AACTrackImpl.this.dataSource.map(this.val$currentPosition, this.val$frameSize);
            } catch (Throwable e) {
        ...
        public void writeTo(WritableByteChannel writableByteChannel) {
            AACTrackImpl.this.dataSource.transferTo(this.val$currentPosition, this.val$frameSize, writableByteChannel);
        }
    }
    ...
    public AACTrackImpl(DataSource dataSource, String str) {
        ...
        Object audioSampleEntry = new AudioSampleEntry(AudioSampleEntry.TYPE3);
    ...
    private AdtsHeader readSamples(DataSource dataSource) {
        ...
        while (true) {
            ...
            AdtsHeader adtsHeader2 = adtsHeader == null ? readADTSHeader : adtsHeader;
            this.samples.add(new C03231(dataSource.position(), (long) (readADTSHeader.frameLength - readADTSHeader.getSize())));
